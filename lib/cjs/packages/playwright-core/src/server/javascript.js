...
const utilityScriptSource = require('../generated/utilityScriptSource.js');
...
class ExecutionContext extends instrumentation.SdkObject {
  constructor(parent, delegate, worldNameForTest) {
    super(parent, "execution-context");
    this._contextDestroyedScope = new manualPromise.LongStandingScope();
  ...
  utilityScript() {
    if (!this._utilityScriptPromise) {
      ...
      (() => {
        ...
        return new (module.exports.UtilityScript())(globalThis, ${debug.isUnderTest()});
      })();`;
...
class JSHandle extends instrumentation.SdkObject {
...
async function evaluateExpression(context, expression, options, ...args) {
  ...
  args = args.map((arg) => utilityScriptSerializers.serializeAsCallArgument(arg, (handle) => {
