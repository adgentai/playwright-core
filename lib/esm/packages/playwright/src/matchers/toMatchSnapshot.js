...
import { expectTypes, addSuffixToFilePath, callLogText } from '../util.js';
...
function toMatchSnapshot(received, nameOrOptions = {}, optOptions = {}) {
  ...
  const header = matcherHint(this, void 0, "toMatchSnapshot", receiver, void 0, void 0);
...
async function toHaveScreenshot(pageOrLocator, nameOrOptions = {}, optOptions = {}) {
  ...
  if (!hasSnapshot) {
    ...
    if (errorMessage2) {
      const header2 = matcherHint(this, locator, "toHaveScreenshot", receiver, void 0, void 0, timedOut2 ? timeout : void 0);
  ...
  if (helper.updateSnapshots === "changed" || helper.updateSnapshots === "all")
    return writeFiles();
  const header = matcherHint(this, void 0, "toHaveScreenshot", receiver, void 0, void 0, timedOut ? timeout : void 0);
