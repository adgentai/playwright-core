...
import { removeFolders } from '../../../playwright-core/src/server/utils/fileUtils.js';
...
import { gracefullyCloseAll } from '../../../playwright-core/src/server/utils/processLauncher.js';
...
import { deserializeConfig } from '../common/configLoader.js';
import { setCurrentTestInfo } from '../common/globals.js';
import { stdioChunkToParams } from '../common/ipc.js';
import { debugTest, relativeFilePath } from '../util.js';
import { FixtureRunner } from './fixtureRunner.js';
import { TestInfoImpl, TestSkipError } from './testInfo.js';
import { testInfoError } from './util.js';
import { inheritFixtureNames } from '../common/fixtures.js';
import { PoolBuilder } from '../common/poolBuilder.js';
import { ProcessRunner } from '../common/process.js';
import { bindFileSuiteToProject, applyRepeatEachIndex, filterTestsRemoveEmptySuites } from '../common/suiteUtils.js';
import { loadTestFile } from '../../../../mocks/testLoader.js';

class WorkerMain extends ProcessRunner {
  constructor(params) {
    super();
    ...
    this._runFinished = new ManualPromise();
  ...
  async gracefullyClose() {
    try {
      ...
      const fakeTestInfo = new TestInfoImpl(this._config, this._project, this._params, void 0, 0, () => {
      }, () => {
      }, () => {
      });
