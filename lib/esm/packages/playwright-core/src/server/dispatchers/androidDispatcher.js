...
class AndroidDispatcher extends Dispatcher {
...
class AndroidDeviceDispatcher extends Dispatcher {
...
class SocketSdkObject extends SdkObject {
...
class AndroidSocketDispatcher extends Dispatcher {
...
export { AndroidDeviceDispatcher, AndroidDispatcher, AndroidSocketDispatcher };
