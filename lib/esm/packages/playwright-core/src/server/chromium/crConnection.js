...
class CRConnection extends SdkObject {
...
class CRSession extends SdkObject {
...
class CDPSession extends SdkObject {
...
export { CDPSession, CRConnection, CRSession, ConnectionEvents, kBrowserCloseMessageId };
