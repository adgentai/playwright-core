...
import { source } from '../generated/utilityScriptSource.js';
...
import { serializeAsCallArgument } from '../utils/isomorphic/utilityScriptSerializers.js';

class ExecutionContext extends SdkObject {
...
class JSHandle extends SdkObject {
...
export { ExecutionContext, JSHandle, JavaScriptErrorInEvaluate, evaluate, evaluateExpression, isJavaScriptErrorInEvaluate, normalizeEvaluationExpression, parseUnserializableValue, sparseArrayToString };
