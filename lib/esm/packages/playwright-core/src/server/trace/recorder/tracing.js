...
import { SerializedFS, removeFolders } from '../../utils/fileUtils.js';
import { HarTracer } from '../../har/harTracer.js';
...
class Tracing extends SdkObject {
...
export { Tracing, shouldCaptureSnapshot };
